...
% \logo{
% \includegraphics[scale=0.05]{logo_uppa.jpg}%
%   \hspace{\dimexpr\paperwidth-2cm}%
% \includegraphics[height=0.8cm, width=1cm]{logo_upv.jpg}%
% 
% }
...
%  \setbeameroption{show notes on second screen=<location> (top, bottom, left)}
...
\setlength{\subplotheight}{0.45\textwidth}
