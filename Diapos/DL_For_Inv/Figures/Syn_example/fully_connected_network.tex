\begin{tikzpicture}
	\node[] () at (0,-0.2) {\begin{tikzpicture}[scale=0.62]
		...
		\addplot[thick] graphics[xmin=0,xmax=3,ymin=0,ymax=13] {Diapos/DL_For_Inv/Figures/Syn_example/resis1};
		\end{axis}
		\end{tikzpicture}};
	...
	\node[] () at (8.8, 1.2) {\includegraphics[width=2.5cm]{Diapos/DL_For_Inv/Figures/Syn_example/res1}};
	\node[] () at (8.8,-1.4) {\includegraphics[width=2.5cm]{Diapos/DL_For_Inv/Figures/Syn_example/res2}};
